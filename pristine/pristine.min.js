!function (e, r) {
  ...
  var n = {
    ...
    a = /-message(?:-([a-z]{2}(?:_[A-Z]{2})?))?/, o = "en", l = {}, u = function (e, r) {
  ...
  function f(t, s, u) {
    ...
    function p(t) {
      for (var n = [], i = !0, s = 0; t.validators[s]; s++) {
        var a = t.validators[s], l = t.params[a.name] ? t.params[a.name] : [];
    ...
    function m(e) {
      ...
      var r = function (e, r) {
        ...
        return e
      }(e.input, f.config.classTo), t = null, n = null;
      ...
      e.setAttribute("novalidate", "true"), f.form = e, f.config = function (e, r) {
        ...
        return [].forEach.call(e.attributes, (function (e) {
          if (/^data-pristine-/.test(e.name)) {
            var s = e.name.substr(14), o = s.match(a);
            if (null !== o) {
